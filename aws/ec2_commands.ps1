...
scp -i ".\bp2.pem" "../pyomo_scripts/pyomo_datagen_simple.py" "../pyomo_scripts/pyomo_datagen.py" "../pyomo_scripts/solver_function.py" "../pyomo_scripts/continuity_datagen_para.py" "${remoteIP}:/home/ubuntu/bp/pyomo_scripts/"
