...
connections = {
    'source_blend':{'s1': ['j1', 'j2', 'j3', 'j4'], 's2': ['j1', 'j2', 'j3', 'j4']},
    'source_demand':{'s1': [], 's2': []},
...
cols_obs = [
    ...
    'demands_q1', 'demands_p2',
    'properties_j1_q1', 'properties_j2_q1', 'properties_j3_q1', 'properties_j4_q1',
    'sources_avail_next_0_s1', 'sources_avail_next_0_s2', 'demands_avail_next_0_q1', 'demands_avail_next_0_p2',
    'sources_avail_next_1_s1', 'sources_avail_next_1_s2', 'demands_avail_next_1_q1', 'demands_avail_next_1_p2',
    'sources_avail_next_2_s1', 'sources_avail_next_2_s2', 'demands_avail_next_2_q1', 'demands_avail_next_2_p2',
    'sources_avail_next_3_s1', 'sources_avail_next_3_s2', 'demands_avail_next_3_q1', 'demands_avail_next_3_p2',
    'sources_avail_next_4_s1', 'sources_avail_next_4_s2', 'demands_avail_next_4_q1', 'demands_avail_next_4_p2',
    'sources_avail_next_5_s1', 'sources_avail_next_5_s2', 'demands_avail_next_5_q1', 'demands_avail_next_5_p2',
    't'
]
cols_act = [
    ...
    'blend_demand_j1_q1', 'blend_demand_j1_p2',
    'blend_demand_j2_q1', 'blend_demand_j2_p2',
    'blend_demand_j3_q1', 'blend_demand_j3_p2',
    'blend_demand_j4_q1', 'blend_demand_j4_p2',
    'tau_s1', 'tau_s2',
    'delta_q1', 'delta_p2'
]
...
def gen_data_1(p=0.2):
    ...
    d_amounts = {'p1': [0] + [dmds[k].__round__(1) for k in range(0, 5)] ,
                 'p2': [0] + [dmds[k].__round__(1) for k in range(5, 10)]}
...
def gen_data_2():
    ...
    d_amounts = {'p1': [0] + [total_product//10 for _ in range(0, 5)] ,
                 'p2': [0] + [total_product//10 for _ in range(5, 10)]}
...
def gen_data_3(p=0.2):
    ...
    d_amounts = {'p1': [0] + [dmds[k].__round__(1) for k in range(0, T-1)] ,
                 'p2': [0] + [dmds[k].__round__(1) for k in range(T-1, 2*(T-1))]}
...
for n in range(N):
    ...
    for t in range(T):
        dataobs.append([
            ...
            d_amounts["p1"][2+t] if 2+t < T else 0,  #  (22, ['demands_avail_next_2', 'q1']),
            d_amounts["p2"][2+t] if 2+t < T else 0,  #  (23, ['demands_avail_next_2', 'p2']),
            
            s_amounts["s1"][3+t] if 3+t < T else 0,  #  (24, ['sources_avail_next_3', 's1']),
            s_amounts["s2"][3+t] if 3+t < T else 0,  #  (25, ['sources_avail_next_3', 's2']),
            d_amounts["p1"][3+t] if 3+t < T else 0,  #  (26, ['demands_avail_next_3', 'q1']),
            d_amounts["p2"][3+t] if 3+t < T else 0,  #  (27, ['demands_avail_next_3', 'p2']),
            
            s_amounts["s1"][4+t] if 4+t < T else 0,  #  (28, ['sources_avail_next_4', 's1']),
            s_amounts["s2"][4+t] if 4+t < T else 0,  #  (29, ['sources_avail_next_4', 's2']),
            d_amounts["p1"][4+t] if 4+t < T else 0,  #  (30, ['demands_avail_next_4', 'q1']),
            d_amounts["p2"][4+t] if 4+t < T else 0,  #  (31, ['demands_avail_next_4', 'p2']),
            
            s_amounts["s1"][5+t] if 5+t < T else 0,  #  (32, ['sources_avail_next_5', 's1']),
            s_amounts["s2"][5+t] if 5+t < T else 0,  #  (33, ['sources_avail_next_5', 's2']),
            d_amounts["p1"][5+t] if 5+t < T else 0,  #  (34, ['demands_avail_next_5', 'q1']),
            d_amounts["p2"][5+t] if 5+t < T else 0,  #  (35, ['demands_avail_next_5', 'p2']),
            t                                        #  (36, ['t'])
        ])
        ...
        dataact.append([
            ...
            model.blend_demand_flow["j1", "p1", t].value,  # (8, ['blend_demand', 'j1', 'q1']),
            model.blend_demand_flow["j1", "p2", t].value,  # (9, ['blend_demand', 'j1', 'p2']),
            model.blend_demand_flow["j2", "p1", t].value,  # (10, ['blend_demand', 'j2', 'q1']),
            model.blend_demand_flow["j2", "p2", t].value,  # (11, ['blend_demand', 'j2', 'p2']),
            model.blend_demand_flow["j3", "p1", t].value,  # (12, ['blend_demand', 'j3', 'q1']),
            model.blend_demand_flow["j3", "p2", t].value,  # (13, ['blend_demand', 'j3', 'p2']),
            model.blend_demand_flow["j4", "p1", t].value,  # (14, ['blend_demand', 'j4', 'q1']),
